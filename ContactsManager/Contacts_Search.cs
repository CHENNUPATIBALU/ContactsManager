...
{
    public partial class Contacts_Search : Form
    {
        private readonly string path = @"C:\Users\" + Environment.UserName + @"\Documents\Contacts.txt";
        ...
        private void writeContacts()
        {
            string s = "sunil" + "\n" + "1234567890" + "\n" +
                     ...
                     "Nanda" + "\n" + "9876543210" + "\n" +
                     "sunil" + "\n" + "1234567890" + "\n";
            File.WriteAllText(@"C:\Users\" + Environment.UserName + @"\Documents\Contacts.txt", s);
        }
